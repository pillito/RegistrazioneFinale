...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "registrazionefinale" because\n';
  ...
  $wnd.__gwt_activeModules['registrazionefinale'] = {
    'moduleName' : 'registrazionefinale',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/registrazionefinale.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['registrazionefinale'].superdevmode = true;

  var expectedSuffix = '/registrazionefinale.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + registrazionefinale + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:registrazionefinale';
  var devModeSessionKey = '__gwtDevModeSession:registrazionefinale';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/registrazionefinale/registrazionefinale.nocache.js';
  ...
  $wnd.__gwt_activeModules['registrazionefinale'].canRedirect = true;
  $wnd.__gwt_activeModules['registrazionefinale'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING registrazionefinale';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/registrazionefinale?user.agent=' + ua + '&_callback=' + callback;
